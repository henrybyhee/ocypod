// Copied from: https://github.com/mitsuhiko/redis-rs/blob/master/tests/support/mod.rs (with some minor tweaks).

#![allow(dead_code)]

use std::{fs, io, net::{SocketAddr, TcpListener}, path::PathBuf, process, thread::sleep, time::Duration};
